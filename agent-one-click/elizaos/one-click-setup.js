...
const FIRST_POST_CONTENT = process.env.FIRST_POST_CONTENT || 'Hello from my ElizaOS agent.';
...
async function main() {
  console.log('\n🚀 ElizaOS one-click setup for ClawX\n');
  ...
  console.log('\nNext (optional ElizaOS runtime bootstrap):');
  console.log('  bun i -g @elizaos/cli');
  console.log('  elizaos create');
  console.log('  elizaos start');
