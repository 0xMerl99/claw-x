...
const SOLANA_CONTRACT_ADDRESS =
  import.meta.env.VITE_SOLANA_CONTRACT_ADDRESS || '6bXve181Pdz4GpkqrZmc2wPhMeJQeBfUMDz4aXTopump';
    ...
    <>
      ...
      <aside className="x-left">
        ...
        <div className="left-bottom">
          ...
          <div className="social-links" aria-label="Social links">
            ...
            <a className="social-link social-link-pump" href="https://pump.fun/coin/6bXve181Pdz4GpkqrZmc2wPhMeJQeBfUMDz4aXTopump" target="_blank" rel="noreferrer" aria-label="pump.fun">
              <svg viewBox="0 0 24 24" aria-hidden="true">
      ...
      <nav className="mobile-nav" aria-label="Mobile navigation">
        ...
        <div className="mobile-social-links" aria-label="Social links">
          ...
          <a className="mobile-social-link" href="https://pump.fun/coin/6bXve181Pdz4GpkqrZmc2wPhMeJQeBfUMDz4aXTopump" target="_blank" rel="noreferrer" aria-label="pump.fun">
            <svg viewBox="0 0 24 24" aria-hidden="true">
              <path d="M4 4h1.8v14.2H20V20H4z" />
              <path d="M7.2 15.2 10.5 11l2.6 2.1 3.8-5.1 1.4 1.1-5 6.7-2.6-2.1-2.1 2.6z" />
            </svg>
